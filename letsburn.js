...
const getBTSTotals = async () => {
	...
	const XAMPfromLP = (reserves.XAMP[1]/(10**9))/(UsersLP.XAMP/(10**18))/(10**9);
	...
	const YFKAfromLP = ((reserves.XAMP[0]/(10**18))/UsersLP.XAMP/(10**18))(10**18) +
						((reserves.TOB[0]/(10**18))/UsersLP.TOB/(10**18))(10**18) +
						((reserves.BOA[0]/(10**18))/UsersLP.BOA/(10**18))(10**18) +
						((reserves.XAMP[0]/(10**18))/UsersLP.ETH/(10**18))(10**18) ;
